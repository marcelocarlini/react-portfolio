...
export function Contact() {
  ...
  const contacts = [
    {
      name: "WhatsApp",
      description: "+55 31 9.9439-6945",
      link: "https://wa.me/5531994396945?text=Olá...",
      icon: <FaWhatsapp className="h-10 w-10" />,
    },
    {
      name: "Email",
      description: "marcelocarlini@hotmail.com",
      link: "mailto:marcelocarlini@hotmail.com?subject=Olá...",
